...
app = Flask(__name__, template_folder='C:\\Users\\swapn\\Videos\\My projects\\Healthcare\\templates')
...
def predict():
    if request.method=='POST':
        ...
        return render_template('index.html', predicted_disease=predicted_disease, dis_des=descr, dis_pre=my_pre, dis_med=med, dis_wrkout=my_workout, dis_diet=die)
